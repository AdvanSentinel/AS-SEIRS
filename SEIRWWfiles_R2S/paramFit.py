...
def paramFit(params,YC,YW,C,gs,es,ns,S_init):
    ...
    # Find nu
        params['nu'] = 1
        SEIR_WW_return = SEIR_WW(params,YC,YW,C,[True,False],1000,S_init)
    ...
    SEIR_WW_return = SEIR_WW(params,YC,YW,C,[False,True],1000,S_init)
